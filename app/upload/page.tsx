                    ...
                    <div className="mt-8 md:flex gap-6">
                        ...
                        {!fileDisplay ? 
                            ...
                            >
                                ...
                                <label 
                                    htmlFor="fileInput" 
                                    className="px-2 py-1.5 mt-8 text-white text-[15px] w-[80%] bg-[#00bfff] rounded-sm cursor-pointer"
                                >
                                    Select file
                                </label>
                                <input 
                        ...
                        <div className="mt-4 mb-6">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button 
                                    ...
                                    className="px-10 py-2.5 mt-8 border text-[16px] text-white bg-[#00bfff] rounded-sm"
                                >
