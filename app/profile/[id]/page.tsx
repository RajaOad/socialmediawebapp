...
export default function Profile({ params }: ProfilePageTypes) {
    ...
    return (
        <>
            <MainLayout>
                <div className="pt-[90px] md:ml-[90px] 2xl:pl-[185px] lg:pl-[160px] lg:pr-0 px-4 w-full md:w-[calc(100%-90px)] md:pr-3 max-w-[1800px] 2xl:mx-auto">
                    ...
                    <div className="flex w-[calc(100vw-230px)]">
                        ...
                        <div className="ml-5 w-full">
                            <ClientOnly>
                                {(currentProfile as User)?.name ? (
                                    <div>
                                        ...
                                        {/* <p className="text-[18px] truncate"></p> */}
                                    </div>
                                ) : (
                            ...
                            {contextUser?.user?.id == params?.id ? (
                                ...
                                <button className="flex item-center rounded-md py-1.5 px-8 mt-3 text-[15px] text-white font-semibold bg-[#00bfff]">
                                    Follow
                                </button>
                            )}
                        </div>
