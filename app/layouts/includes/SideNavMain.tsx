    ...
    return (
        <>
            <div 
                id="SideNavMain" 
                className={`
                    fixed z-20 bg-white pt-[70px] h-full hidden md:block lg:border-r-0 border-r w-[75px] overflow-auto
            ...
            >
                ...
                <div className="lg:w-full w-[55px] mx-auto">
                    ...
                    <button className="lg:block hidden text-[#00bfff] pt-1.5 pl-2 text-[13px]">See all</button>
                    ...
                    {/* {contextUser?.user?.id ? (
                        <div >
                            ...
                            <button className="lg:block hidden text-[#00bfff] pt-1.5 pl-2 text-[13px]">See more</button>
                        </div>
                    ) : null} */}
