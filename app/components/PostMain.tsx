...
export default function PostMain({ post }: PostMainCompTypes) {
    ...
    return (
        <>
            <div id={`PostMain-${post.id}`} className="flex justify-center md:justify-start border-b py-6">
                <div>
                    <div className="md:pl-3 w-full px-4">
                        ...
                        <div className="flex items-center pb-0.5">
                            ...
                            {/* <button className="border text-[15px] px-[21px] py-0.5 border-[#00bfff] text-[#00bfff] hover:bg-[#ffeef2] font-semibold rounded-md">
                            Follow
                        </button> */}
                        </div>
